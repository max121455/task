...
namespace ego_planner
{
      ...
      Eigen::MatrixXd &optimal_points, const bool use_formation)
  {
    ...
    //优化器参数-内存大小，保留最后16次迭代的信息
    lbfgs_params.mem_size = 16;
    //优化器参数-梯度阈值，梯度模长<0.1默认为收敛
  ...
  void PolyTrajOptimizer::setParam(ros::NodeHandle &nh)
  {
    ...
    nh.param("optimization/a_star_map/x", a_star_map_x_, 0);
    nh.param("optimization/a_star_map/y", a_star_map_y_, 0);
    nh.param("optimization/a_star_map/z", a_star_map_z_, 0);
  ...
  void PolyTrajOptimizer::setEnvironment(const GridMap::Ptr &map)
  {
    ...
    ("a_star_map_size:[%d, %d, %d]", a_star_map_x_, a_star_map_y_, a_star_map_z_);
    a_star_->initGridMap(grid_map_, Eigen::Vector3i(a_star_map_x_, a_star_map_y_, a_star_map_z_));
