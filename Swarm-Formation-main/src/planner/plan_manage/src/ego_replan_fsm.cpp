...
namespace ego_planner
{
  ...
  void EGOReplanFSM::init(ros::NodeHandle &nh)
  {
    ...
    nh.param("fsm/flight_height", flight_height_, 0.0);
  ...
  void EGOReplanFSM::formationWaypointCallback(const geometry_msgs::PoseStampedPtr &msg)
  {
    ...
    swarm_central_pos_(2) = flight_height_;
    ROS_ERROR("swarm_central_pos_:%.2f", swarm_central_pos_(2));
