...
namespace ego_planner
{
  ...
  void PlanningVisualization::initSwarmGraphVisual(){
    ...
    case FORMATION_TYPE::RHOMBUS:
    {
      ...
      line_begin_.resize(line_size_);
      line_end_.resize(line_size_);
      line_begin_ = {0, 0, 0, 1, 1, 2};
      line_end_   = {1, 2, 3, 2, 3, 3};
      break;
    }
    ...
    case FORMATION_TYPE::TRIANGLE10:
    {
      ...
      line_begin_.resize(line_size_);
      line_end_.resize(line_size_);
      line_begin_ = {0, 0, 1, 1, 1, 2, 2, 2, 3, 4, 4, 5, 5, 5, 6, 7, 7, 8};
      line_end_   = {1, 4, 2, 4, 5, 3, 5, 6, 6, 5, 7, 6, 7, 8, 8, 8, 9, 9};
      break;
    }
    ...
    case FORMATION_TYPE::SQUARE:
    {
      ...
      line_begin_.resize(line_size_);
      line_end_.resize(line_size_);
      line_begin_ = {0, 0, 0, 1, 1, 2, 2, 3};
      line_end_   = {1, 3, 4, 2, 4, 3, 4, 4};
      break;
    }
