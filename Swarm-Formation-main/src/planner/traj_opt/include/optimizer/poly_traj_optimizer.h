...
namespace ego_planner
{
  ...
  private:
    ...
    int a_star_map_x_, a_star_map_y_, a_star_map_z_;
  ...
  private:
    ...
    void setDesiredFormation(int type){
      ...
      switch (type)
      {
        ...
        case FORMATION_TYPE::RHOMBUS :
        {
          // set the desired formation
          Eigen::Vector3d v0(0,0,0);
          Eigen::Vector3d v1(1.7321,1,0);
          Eigen::Vector3d v2(1.7321,3,0);
        ...
        case FORMATION_TYPE::TRIANGLE10 :
        {
          // set the desired formation
          Eigen::Vector3d v0(0,0,0);
          Eigen::Vector3d v1(-1.732,1.0,0.0);
          Eigen::Vector3d v2(-3.464,2.0,0.0);
          Eigen::Vector3d v3(-5.196,3.0,0.0);
          Eigen::Vector3d v4(-1.732,-1.0,0.0);
          Eigen::Vector3d v5(-3.464,0.0,0.0);
          Eigen::Vector3d v6(-5.196,1.0,0.0);
          Eigen::Vector3d v7(-3.464,-2.0,0.0);
          Eigen::Vector3d v8(-5.196,-1.0,0.0);
          Eigen::Vector3d v9(-5.196,-3.0,0.0);
        ...
        case FORMATION_TYPE::SQUARE:
        {
          ...
          Eigen::Vector3d v2(-2.0,2.0,0.0);
          Eigen::Vector3d v3(-0.0,2.0,0.0);
          Eigen::Vector3d v4(-1.0,1.0,0.0);
